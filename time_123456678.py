...
d1_str = input("Перша (20.12.2024),(2024-12-20),(December 20, 2024),(20/12/2024) пиши так тогошо за допомогою parse так можна : ")
d2_str = input("Друга (20.12.2024),(2024-12-20),(December 20, 2024),(20/12/2024) пиши так тогошо за допомогою parse так можна : ")
try:
